...
char swap_tiles(int x1, int y1, int x2, int y2) { 
...
int main(void) {
    ...
    InitWindow(screen_width, screen_height, "Raylib ASCII MATCH-3");
    SetTargetFPS(60);
    srand(time(NULL));
    ...
    while(!WindowShouldClose()) {
        ...
        // Total Score
        // Basic format : DrawText(TextFormat("SCORE: %d", score), 20, 20, 24, YELLOW);
